...
?>
<div class="genero-view container my-4 text-white">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <?php if (!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'admin'): ?>
                <?= Html::a(Yii::t('app', 'Update'), ['update', 'idgenero' => $model->idgenero], ['class' => 'btn btn-primary fw-bold px-3']) ?>
    ...
    <div class="card border-0 p-4 shadow-lg" style="background: #141a29; border-radius: 12px; border: 1px solid #1f293d !important;">
        ...
        <?= DetailView::widget([
            'model' => $model,
            // Forzamos estilos inline para arrancar cualquier fondo blanco de Bootstrap
            'options' => [
