        ...
        return array_merge(
            ...
            [
                'access' => [
                    ...
                    'rules' => [
                        // 1. Cualquier persona (invitado o logueado) puede ver la lista y el detalle de actores
                        [
                            'allow' => true,
                            'actions' => ['index', 'view'],
                            'roles' => ['?', '@'],
                        ],
                        // 2. Cualquier usuario logueado puede agregar/crear un nuevo actor
                        [
                            'allow' => true,
                            'actions' => ['create'],
                            'roles' => ['@'],
                        ],
                        // 3. Solo el administrador puede modificar o eliminar actores
                        [
                            'allow' => true,
